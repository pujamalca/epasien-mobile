@extends('layouts.app')
@section('title', 'Persetujuan Tindakan')
@section('content')
<div class="page">
    <div class="topbar">
        <button class="topbar-back" id="backBtn">&#8592;</button>
        <div class="topbar-title">Persetujuan Tindakan</div>
    </div>
        ...
        <div id="signView" style="display:none;">
            ...
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:16px;">
                ...
                <label style="display:flex;align-items:center;gap:6px;font-size:var(--font-sm);cursor:pointer;">
                    <input type="checkbox" id="confirmCheck"> Saya menyetujui tindakan ini
                </label>
            </div>
...
(function () {
    ...
    document.getElementById('btnSign').addEventListener('click', async function () {
        ...
        try {
            ...
            var data = await apiFetch('/api/consent/sign/consent', {
                method: 'POST',
    ...
    async function loadList() {
        ...
        try {
            var data = await apiFetch('/api/consent/list/consent');
